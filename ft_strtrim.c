...
static int	ruleout_front(char const *s1, char const *set)
{
	int		ia;
	int		ib;
	int		f_find;
...
static int	ruleout_back(char const *s1, char const *set)
{
	int		ia;
	int		ib;
	int		f_find;
...
char	*ft_strtrim(char const *s1, char const *set)
{
	...
	i_front = ruleout_front(s1, set);
	i_back = ruleout_back(s1, set);
	if (i_front < i_back)
